        ...
        >
            <div className="title-bar login-header" id="login-header">
                <div className="title-bar-text">
                    <img src="/login/running-man.svg" alt="" className="h-[16px] inline-block" /> Sign On
                </div>
            ...
            <div className="window-body px-1">
                ...
                <form onSubmit={handleLogin} className="px-3 py-2">
                    ...
                    <input type="checkbox" id="savePass" /> <label htmlFor="savePass">Save password</label>
                    <input type="checkbox" id="autoLogin" className="ml-2" /> <label htmlFor="autoLogin">Auto-login</label>
